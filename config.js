...
// Auth information
global.pairNumber = "233559762219";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["233559762219", "233559762219"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["233559762219", "233559762219"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["233559762219"];
global.OwnerName = process.env.OWNER_NAME || "DENDA";
global.BotName = process.env.BOT_NAME || "EMPIRE DENDA";
global.packname = process.env.PACK_NAME || "A17 Bot";
global.author = "By: Kai";
global.BotSourceCode = "https://github.com/Kai0071/A17";
global.SupportGroupLink = "https://https://chat.whatsapp.com/KzfbI7aO11vJ3Bg993IVyi";


//
global.openAiAPI = process.env.OPENAI_API || "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";
global.location = process.env.LOCATION || "GHANA";
